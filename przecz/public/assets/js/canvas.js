...
functions.initVariable = function (varObj) {
  ...
  mainCtx.fillText(
    ...
    options.canvas.variableCount * options.grid.height * 2 - 
      options.grid.height * 0.25
  );
...
function checkHeight() {
  // i
  if(options.canvas.variableCount * options.grid.height * 2 > 
  ...
  // Clear canvas
  options.grid.canvas.getContext('2d')
    .clearRect(0, 0, options.grid.width, options.grid.height);
